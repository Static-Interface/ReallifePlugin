...
import de.static_interface.reallifeplugin.module.bank.database.row.AccountRow;
import de.static_interface.sinklibrary.database.AbstractTable;
import de.static_interface.sinklibrary.database.Database;

public class AccountsTable extends AbstractTable<AccountRow> {

    public static final String TABLE_NAME = "banking_accounts";
