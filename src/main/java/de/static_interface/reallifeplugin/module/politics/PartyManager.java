...
public class PartyManager {
    ...
    public void createNewPary(String partyName, String tag, UUID founder) {
        ...
        party.addMember(founder, founderRank);
    }
    ...
    public Party getParty(IngameUser user) {
        PartyUser[] rows = module.getTable(PartyUsersTable.class).get("SELECT * FROM `{TABLE}` WHERE `uuid` = ?", user.getUniqueId().toString());
