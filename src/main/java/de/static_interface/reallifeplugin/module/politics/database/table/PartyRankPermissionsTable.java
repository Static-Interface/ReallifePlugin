...
public class PartyRankPermissionsTable extends OptionsTable {

    public PartyRankPermissionsTable(Database db) {
        super("party_rank_permissions", db);
    }

    @Override
    public Class<? extends AbstractTable> getForeignTable() {
        return PartyRanksTable.class;
    }
